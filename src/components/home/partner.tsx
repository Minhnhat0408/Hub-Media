...
function Partner({lang}:{lang:Locale}) {
    return (
        <section id='partner' className="flex w-full flex-col items-center  bg-muted md:py-20 py-10">
            <Heading title={'Partner'} description={lang === 'vi' ? 'Đối tác': "Core Partners"} className='xl:!pb-10 !pb-0'/>
            <div className='flex flex-wrap justify-evenly w-full gap-y-4 lg:max-h-[200px] '>
                <Image
                    src={
                ...
                <div className='lg:!w-[200px] ssm:w-[30%] flex justify-center items-center w-1/2 object-contain duration-500 hover:scale-125 xl:px-0 px-6 '>
                    <Image
                        src={
