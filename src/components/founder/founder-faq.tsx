        ...
        <section id="faq" className="flex w-full   py-20  ">
            <div className="relative z-10 flex flex-1 items-center justify-end  px-4  lg:px-0  ">
                <div
                    ...
                    className="flex  min-h-[80%]  w-full flex-col border-2 border-secondary  p-6 lg:translate-x-8 xl:translate-x-24 2xl:!p-20 ssm:p-10"
                >
                    ...
                    <Accordion type="single" collapsible className="xl:mt-10 ">
                        <AccordionItem value="item-1" className="border-muted-foreground">
                            <AccordionTrigger className="py-8 hover:no-underline xl:py-10 ">
                                <div className="flex ">
                                    <PiPaperPlaneRightFill className=" mr-7 mt-1 hidden text-xl text-secondary xl:text-2xl ssm:block" />
                ...
                <div className="absolute -right-28 -top-6 hidden h-36 w-36 items-center justify-center text-secondary lg:flex xl:-right-36 xl:-top-10 xl:h-48 xl:w-48 ">
                    <Image
                        src={
                    ...
                    />
                    <div className="absolute -rotate-90  text-5xl text-[#4d4d4d] xl:text-6xl">
                        <PiPaperPlaneRightFill />
                    </div>
                </div>
            </div>
            <Image
                src="https://utfs.io/f/ad8c9310-0ae8-4dbc-b334-90aa9463f230-261i.png"
                width={0}
                height={0}
                sizes="100vw"
                alt="illustrate"
